...
<form class="form-horizontal" action="{{ 'store_particular' }}" onsubmit="return validate_form()" method="POST">
    {{ csrf_field() }}
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        ...
                        <div class="form-group" style="float: left;margin-right: -17px;">
                            <label for="product_count" class="col-md-4 control-label" style="
                                margin-left: -17px;">Count</label>
                            <div class="col-md-4">
                                <input id="product_count" type="text" class="form-control" name="email" value="0" readonly>
                            </div>
                        </div>
                        <div class="form-group" style="float: left; margin-left:-131px">
                            <label for="invoiceTotal" class="col-md-4 control-label">Amount</label>
                            <div class="col-md-8">
                                <input id="{{ TOTAL_AMOUNT }}" readonly type="text" class="form-control" name="{{ TOTAL_AMOUNT }}" value="0.00">
                        ...
                        <div class="form-group" style="float: left; margin-left:-1px">
                            ...
                            <div class="col-md-10">
                                ...
                                ->value('customer_name');
                                @endphp
                                <input id="{{ CUSTOMER_NAME }}" readonly type="text" class="form-control" name="{{ CUSTOMER_NAME }}" style="width: 300px;" value="{{ $customer_name }}" required readonly>
                                <input id="{{ CUSTOMER_INR_ID }}" readonly type="hidden" class="form-control" name="{{ CUSTOMER_INR_ID }}" value="{{ $customer_inr_id }}" required readonly>
                        ...
                        <div class="panel-body">
                            <table class="table table-bordered" id="item_table">
                                ...
                                <tr>
                                    <td>
                                        <input id="{{ PRODUCT_NAME }}" list="list_product_name" type="text" class="form-control" name="{{ PRODUCT_NAME }}" value="{{ old(PRODUCT_NAME) }}">
                                    ...
                                    <td>
                                        <input id="{{ PKT }}" type="number" class="form-control" name="{{ PKT }}" value="{{ old(PKT) }}">
                                        <span id="span_pkt"></span>
                                    </td>
                                    <td>
                                        <input id="{{ AMOUNT }}" type="number" class="form-control" name="{{ AMOUNT }}" value="{{ old(AMOUNT) }}" readonly>
                            ...
                            <div class="form-group ">
                                <div class="col-md-12">
                                    <a href="/" style="float: right;margin-top: 10px" role="button" class="btn btn-primary">Back</a>
                                    <button type="submit" style="float: right;margin-top: 10px;margin-right: 10px" class="btn btn-primary">
                                        Click to Add
                                    </button>
                                </div>
                            </div>
