...
@section('content')
    ...
    <form class="form-horizontal" action="{{ 'store_particular' }}" onsubmit="return validate_form()" method="POST">
        ...
        <div class="container">
            ...
            <div class="row" style="margin-right:320px;margin-left:-195px">
                <div class="col-md-12">
                    <div class="panel panel-default">
                        @include('input_box_error_message')
                        @include('flash_message')
                        <div class="form-group" style="float: left;">
                            <label for="product_count" class="col-md-5 control-label">Count</label>
                            <div class="col-md-4">
                                <input id="product_count" type="text" class="form-control" name="email" value="0"
                                    readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group" style="float: left; margin-left:-1px">
                            ...
                            <div class="col-md-10">
                                ...
                                <input id="{{ CUSTOMER_NAME }}" readonly type="text" class="form-control"
                                    name="{{ CUSTOMER_NAME }}" style="width: 300px;" value="{{ $customer_name }}" required
                                    readonly>
